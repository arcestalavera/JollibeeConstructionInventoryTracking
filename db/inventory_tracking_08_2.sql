...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2016 at 10:26 AM
...
INSERT INTO `deliveries` (`deliveryID`, `supplierID`, `type`, `status`) VALUES
(1, 2, 'Incoming', 'Pending'),
(2, NULL, 'Outgoing', 'Finished'),
(3, NULL, 'Outgoing', 'Cancelled'),
(4, NULL, 'Outgoing', 'In Transit'),
(5, NULL, 'Outgoing', 'In Transit'),
(6, NULL, 'Outgoing', 'In Transit'),
(7, NULL, 'Outgoing', 'In Transit'),
(8, NULL, 'Outgoing', 'Finished');
...
(1, 'Hammer33131313', 'sledgehammer', 'pc', '1'),
(2, 'Nails', 'Nails (in kg)', 'kg', '1'),
(3, 'Board', '100'''' x 100''''', 'pc', '1'),
(4, 'Cement', '1kg sack', 'kg', '0'),
(5, 'Red Paint', '100L Bucket', 'bucket', '0'),
(6, 'Jolliwings', 'asdf', 'pc', '0'),
(7, 'a', 'asdf', 'ssss', '0'),
(8, 'mcdo', 'asdf', 'pc', '0');
...
INSERT INTO `item_of_request` (`itemID`, `requestID`, `deliveryID`, `count`) VALUES
(1, 6, 4, 5),
(2, 7, 2, 10),
(3, 6, 1, 6),
(3, 9, 6, 7),
...
(6, 'JolliTransfer My Hammer!', 3, 2, '2016-07-11 09:06:46', NULL, 'In Transit'),
...
(1, 'Cement Producers Inc.', 'Binan, Laguna', '09123456789', 'supplier@cemprod.com.ph', 'Juan Dela Cruz', '1'),
(2, 'Wood Choppers Inc.', 'Binan, Laguna', '09321456789', 'supplier@woodchop.com.ph', 'Juan Dela Cruz', '1'),
(3, 'JolliSupplier', 'weeland', '123456789', 'JolliSupplier@Jolliweeee.com', 'Juan Dela Cruz', '1'),
(4, 'a', 'b', 'c', 'd', 'Juan Dela Cruz', '1'),
(5, 'w', 'p', 'o', 'i', 'Juan Dela Cruz', '1'),
(6, 'haha333', 'hehe', 'hophop', 'hoho', 'huhu', '0'),
(7, 'sample', 'sample', '09278871602', 'sample@sample.co.ph', 'sample sample', '1');
...
INSERT INTO `users` (`user_id`, `username`, `password`, `type`, `isDeleted`, `fullName`) VALUES
(1, 'admin', 'admin', 0, '0', ''),
(2, 'invmanager', 'invmanager', 1, '0', ''),
(3, 'eofficer', 'eofficer', 2, '0', ''),
(4, 'apiclient', 'apiclient', 3, '0', '');
...
ALTER TABLE `item_of_request`
  ADD PRIMARY KEY (`itemID`,`requestID`,`deliveryID`);
