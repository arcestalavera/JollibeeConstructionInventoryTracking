...
CREATE TABLE `deliveries` (
  ...
  `leadTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `items` VALUES (1,'Hammer','pc'),(2,'Nails','kg'),(3,'100\' x 100\' board','pc'),(4,'1kg cement','sack'),(5,'100L Red Paint','bucket');
...
INSERT INTO `requests` VALUES (1,'2',5,'Finished','Construction Site in Laguna'),(2,'3',4,'Pending Approval','Construction Site in Batangas'),(3,'1',3,'Ongoing','Construction Site in Manila'),(4,'4',2,'Declined','Construction Site in Cavite'),(5,'5',10,'Cancelled','Mcdonalds Construction');
...
INSERT INTO `supplier` VALUES (1,'Cement Producers Inc.','Binan, Laguna','09123456789','supplier@cemprod.com.ph'),(2,'Wood Choppers Inc.','Binan, Laguna','09321456789','supplier@woodchop.com.ph');
...
-- Dump completed on 2016-06-24 19:38:55
