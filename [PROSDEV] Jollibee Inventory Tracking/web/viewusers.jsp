                    ...
                    <table class="table table-hover">
                        ...
                        <tbody id="itemTableBody">
                            <%
                                for (int i = 0; i < userList.size(); i++) {
                                    ...
                                    switch (user.getType()) {
                                        case 0: utype = "Admin";
                                            break;
                                        case 1: utype = "Inventory Manager";
                                            break;
                                        case 2: utype = "External Officer";
                                            break;
                                        case 3: utype = "API Client";
                                            break;
                                    }
                            %>
                            <tr id = "i<%=user.getUserID()%>">
                                ...
                                <td style="width: 40%;"><button type="button" class="btn btn-link name" onclick = "redirect(<%=user.getUserID()%>)"><%=user.getUsername()%></button></td>
                                <td style="width: 40%;"><%=user.getFullName()%></td>
                                <td style="width: 20%;"><%=utype%></td> <!--getUnit-->
                                <%
                                    if (type == 0) {
                                %>
                                <td id = "item-actions" style="white-space: nowrap; text-align: right;">
